...
Returns the Kin **runtime type name** of its argument as a string: `"number"`, `"string"`, `"boolean"`, `"object"`, `"urutonde"` (arrays), `"fn"`, `"native-fn"`, or `"null"`.
