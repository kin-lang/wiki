  ...
  useEffect(() => {
    ...
    if (navbar && !document.getElementById('custom-nav-links')) {
      ...
      docsLink.addEventListener('mouseenter', () => {
        if (!isDocsActive)
          docsLink.style.color = 'var(--nextra-primary-hue, #0070f3)';
      });
      ...
      playgroundLink.rel = 'noopener noreferrer';
      ...
      playgroundLink.addEventListener('mouseenter', () => {
        playgroundLink.style.color = 'var(--nextra-primary-hue, #0070f3)';
      });
      playgroundLink.addEventListener('mouseleave', () => {
        playgroundLink.style.color = 'rgba(156, 163, 175, 1)';
      });
